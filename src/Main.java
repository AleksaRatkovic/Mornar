public class Main {
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                k1.dodajMornara(m4);
                System.out.println("Broj mornara na gusarskom brodu: " + g1.dohvTrenutniBrojMornara());
                System.out.println("Kapetan gusarskog broda: " + g1.dohvKapetana());
                try {
                    System.out.println("Mornar kraljevskog broda na poziciji 1: " + k1.dohvMornaraPrekoIndeksa(1));
                } catch (GIndeks e) {
                }
                ...
                flota.dohvatiBrodIndeksom(0).dodajMornara(new Mornar("G", 50));
